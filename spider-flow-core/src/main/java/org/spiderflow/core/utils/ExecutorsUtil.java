 ...
 */
@Component
public class ExecutorsUtil implements ApplicationContextAware {
    ...
    @Autowired
    ExecutorsUtil(List<ShapeExecutor> executors){
        ExecutorsUtil.executors = executors;
    }
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ExecutorsUtil.applicationContext = applicationContext;
    }
